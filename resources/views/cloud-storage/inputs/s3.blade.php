<div class="mb-3">
    ...
    <input type="password" name="access_key_id" required class="form-control required" id="access_key_id{{ @$ext }}"
...
<div class="mb-3">
    ...
    <input type="password" name="secret_access_key" required class="form-control required" id="secret_access_key{{ @$ext }}"
...
<div class="mb-3">
    ...
    <input type="text" name="bucket" required class="form-control required" id="bucket{{ @$ext }}" aria-describedby="bucket"
        placeholder="BUCKET..." value="{{ old('bucket', @$data->bucket) }}">

</div>
<div class="mb-3">
    <label for="endpoint{{ @$ext }}">ENDPOINT <span class="text-danger">*</span></label>
    <input type="text" name="endpoint" required class="form-control required" id="endpoint{{ @$ext }}" aria-describedby="endpoint"
