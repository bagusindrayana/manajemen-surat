<div class="mb-3">
    ...
    <input type="text" name="host" required class="form-control required" id="host{{ @$ext }}"
...
<div class="mb-3">
    ...
    <input type="text" name="port" required class="form-control required" id="port{{ @$ext }}"
...
<div class="mb-3">
    ...
    <input type="text" name="username" required class="form-control required" id="username{{ @$ext }}"
...
<div class="mb-3">
    ...
    <input type="password" name="password" required class="form-control required" id="password{{ @$ext }}"
...
<div class="mb-3">
    ...
    <input type="text" name="root" required class="form-control required" id="root{{ @$ext }}"
