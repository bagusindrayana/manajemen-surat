        ...
        <ul class="navbar-nav align-items-center">
              ...
              <div class="list-group list-group-flush ">
                  ...
                  <a href="#" class="list-group-item list-group-item-action border-bottom">
                    <div class="row align-items-center">
                      ...
                      <div class="col ps-0 ms-2">
                        ...
                        <p class="font-small mt-1 mb-0">{{ $item->surat->nomor_surat }} / {{ $item->surat->sifat }}
                        </p>
                      </div>
                    </div>
                  </a>
                @endforeach
                @foreach (NotificationHelper::mySurat() as $item)
                  <a href="#" class="list-group-item list-group-item-action border-bottom">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                      ...
                      <div class="col ps-0 ms-2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            <h4 class="h6 mb-0 text-small">{{ $item->status }}</h4>
                          </div>
                          <div class="text-end">
                            @php
                                $updated_at = $item->disposisis()->where('status','ditolak')->orderBy('updated_at','DESC')->first()->updated_at;
                            @endphp
                            <small class="text-danger">{{ $updated_at != null? date("Y-m-d",strtotime($updated_at)):"-" }}</small>
                          </div>
                        </div>
                        <p class="font-small mt-1 mb-0">{{ $item->nomor_surat }} / {{ $item->sifat }}
                        </p>
                      </div>
                    </div>
                  </a>
                ...
                {{-- <a href="#" class="list-group-item list-group-item-action border-bottom">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <img alt="Image placeholder" src="{{ url('/') }}/img/team/profile-picture-2.jpg"
                ...
                <a href="#" class="list-group-item list-group-item-action border-bottom">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <img alt="Image placeholder" src="{{ url('/') }}/img/team/profile-picture-3.jpg"
                        class="avatar-md rounded">
                    </div>
                ...
                <a href="#" class="list-group-item list-group-item-action border-bottom">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <img alt="Image placeholder" src="{{ url('/') }}/img/team/profile-picture-4.jpg"
                        class="avatar-md rounded">
                    </div>
                    <div class="col ps-0 ms-2">
                      <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="#" class="list-group-item list-group-item-action border-bottom">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <img alt="Image placeholder" src="{{ url('/') }}/img/team/profile-picture-5.jpg"
                        class="avatar-md rounded">
                    </div>
                    <div class="col ps-0 ms-2">
                      <div class="d-flex justify-content-between align-items-center">
          ...
          <li class="nav-item dropdown ms-lg-3">
            ...
            <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
              ...
              <form action="{{ route('login.logout') }}" method="POST" class="d-none" id="logout-form">
                @csrf
              </form>
            </div>
          </li>
